            ...
            <tbody>
             ...
             ?>
                 <tr>
                    ...
                    <td>◯◯ ◯◯</td>
                    <td><a href="msg.php?m_id=<?php echo sanitize($val['id']); ?>"><?php echo mb_substr(sanitize($msg['msg']),0,40); ?>...</a></td>  <!-- mb_substrで、取得できる文字列の数を指定できる。 -->
                </tr>
             <?php
                  }else{
             ?>
          ...
          <?php
            ...
            ?>
              <a href="productDetail.php<?php echo (!empty(appendGetParam())) ? appendGetParam().'&p_id='.$val['id'] : '?p_id='.$val['id']; ?>" class="panel">
                ...
                <div class="panel-body">
                  <p class="panel-title"><?php echo sanitize($val['name']); ?> <span class="price">¥<?php echo sanitize(number_format($val['price'])); ?></span></p>  <!-- number_formatは、千位枚にカンマを追加してくれる機能。 -->
                </div>
              </a>
          <?php
            endforeach;
