...
// DBから掲示板とメッセージデータを取得
$viewData = getMsgsAndBord($m_id);  // todo、まずここだ。てかそもそも、INSERTしてないからなくない？そっかだから、RIGHTJOINでとっているのか。最初にメッセージなくない？ID。最初にメッセージを表示させるやつか。DBのメッセージのテーブルをNULLおっけいにするか
...
//商品情報を取得
$productInfo = getProductOne($viewData[0]['product_id']);  // todo
...
$partnerUserId = array_shift($dealUserIds); //配列の最初のKeyをとる。sale_user。
          ...
          <div class="msg-info">
            ...
            <div class="product-info">
              ...
              <div class="right">
                ...
                取引開始日：<?php echo date('Y/m/d',strtotime(sanitize($viewData[0]['create_date']))); ?> <!-- 開始日なので、最初のをとる。-->
              </div>
            </div>
         </div>
